	...
	var DomesticController = ( function DomesticController_Class() {
        ...
        */
		DomesticController.prototype.setResourceToSend = function(resource){
			this.updateResources(resource, false);				
		 ...
		 */
		 DomesticController.prototype.setResourceToReceive = function(resource){		 
			this.updateResources(resource, true);		 
		...
		DomesticController.prototype.updateResources = function(resource, receiving){
			if(receiving){
		...
		DomesticController.prototype.setTradeButton = function(){
				if(	this.woodAmt == 0 && this.brickAmt == 0 && this.wheatAmt == 0 && this.sheepAmt == 0 && this.oreAmt == 0){
					this.view.setTradeButtonEnabled(false);
				}
				else{
					if(this.setResources.length > 0 && this.getResources.length > 0){
						if(	(this.woodAmt > 0  && !this.receivingWood || this.brickAmt > 0 && !this.receivingBrick || this.wheatAmt > 0 && !this.receivingWheat ||
							this.sheepAmt > 0 && !this.receivingSheep || this.oreAmt > 0 && !this.receivingOre) && 
							(this.woodAmt > 0  && this.receivingWood || this.brickAmt > 0 && this.receivingBrick || this.wheatAmt > 0 && this.receivingWheat ||
							this.sheepAmt > 0 && this.receivingSheep || this.oreAmt > 0 && this.receivingOre)){
		...
		*/
		...
		DomesticController.prototype.sendTradeOffer = function(){
			if(this.trader != ""){
				...
				this.offer = {"brick": this.brickAmt,"ore": this.oreAmt,"sheep": this.sheepAmt,"wheat": this.wheatAmt,"wood": this.woodAmt};				
		...
		*/
		...
		DomesticController.prototype.update = function(model){		
			...
			if(this.clientModel.turnTracker.currentTurn != this.clientModel.playerIndex){
				...
				if(typeof this.trade != "undefined"){	
					if(this.trade.receiver == this.clientModel.playerIndex){						
						...
						if(this.trade.offer.wood < 0){
							if(this.trade.offer.wood*(-1) > this.clientModel.players[this.clientModel.playerIndex].resources.wood) 
						...
						if(this.trade.offer.brick < 0){
							if(this.trade.offer.brick*(-1) > this.clientModel.players[this.clientModel.playerIndex].resources.brick) 
								this.acceptView.setAcceptEnabled(false);
							else
								this.acceptView.setAcceptEnabled(true);
						...
						if(this.trade.offer.sheep < 0){
							if(this.trade.offer.sheep*(-1) > this.clientModel.players[this.clientModel.playerIndex].resources.sheep) 
								this.acceptView.setAcceptEnabled(false);
							else
								this.acceptView.setAcceptEnabled(true);
						...
						if(this.trade.offer.ore < 0){
							if(this.trade.offer.ore*(-1) > this.clientModel.players[this.clientModel.playerIndex].resources.ore) 
								this.acceptView.setAcceptEnabled(false);
							else
								this.acceptView.setAcceptEnabled(true);
						...
						if(this.trade.offer.wheat < 0){
							if(this.trade.offer.wheat*(-1) > this.clientModel.players[this.clientModel.playerIndex].resources.wheat) 
								this.acceptView.setAcceptEnabled(false);
							else
								this.acceptView.setAcceptEnabled(true);
