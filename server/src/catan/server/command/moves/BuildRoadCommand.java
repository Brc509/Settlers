...
public class BuildRoadCommand implements Command {
	...
	public Object execute(GameModel game) {
		...
		if ((players[0].getRoads() == 14 && players[0].getCities() == 4) && (players[1].getRoads() == 14 && players[1].getCities() == 4) && (players[2].getRoads() == 14 && players[2].getCities() == 4) && (players[3].getRoads() == 14 && players[3].getCities() == 4)) {
			game.getTurnTracker().setStatus("SecondRound");
		} else if ((players[0].getRoads() == 13 && players[0].getCities() == 3) && (players[1].getRoads() == 13 && players[1].getCities() == 3) && (players[2].getRoads() == 13 && players[2].getCities() == 3) && (players[3].getRoads() == 13 && players[3].getCities() == 3)) {
